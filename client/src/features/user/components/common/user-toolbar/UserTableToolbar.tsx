...
import type { UserTableToolbarProps } from './types';

/**
 * Toolbar component for the User data table.
 * 
 * Provides search, filtering (by role, status, etc.), date range selection, 
 * and refresh/reset functionalities. It is memoized to prevent unnecessary re-renders.
 * 
 * @param {UserTableToolbarProps} props - The toolbar properties including filter states and action callbacks.
