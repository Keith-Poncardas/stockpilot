...
/**
 * Layout component for the RecordInfo section.
 * Wraps children in a FormSection with standard title/icon and appends an immutable notice.
 *
 * @param {RecordInfoLayoutProps} props - The component properties.
