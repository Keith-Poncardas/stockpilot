...
/**
 * Skeleton loader component for the product details section.
 * Renders a placeholder UI that mimics the layout of the ProductDetails component
 * while the actual product data is being fetched.
 *
