...
import { ReorderThresholdsSection, ReorderImpactSummary } from './sections';
...
export function ReorderLevelSheet() {
    ...
    return (
        <BaseSheetLayout
            ...
            icon={BellRing}
            className="w-[95vw]! sm:max-w-xl! md:max-w-2xl! lg:max-w-4xl! flex flex-col gap-0 p-0"
                        ...
                        >
                            ...
                            <div className="lg:col-span-1 space-y-5">
                                <ReorderImpactSummary
                                    control={control}
                                    currentStock={inventory.quantityOnHand}
                                    initialReorderLevel={inventory.reorderLevel}
                                    initialMaxStock={inventory.maxStock}
                                />
                            </div>
                        </form>
                    )}
