...
export function AiStockRecommendation({
                ...
                <div className="flex items-center gap-3.5">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-xs font-bold text-slate-800 tracking-tight">
                            AI Copilot: Stock is Optimal
                        </p>
                        <p className="text-xs text-slate-500 mt-0.5 leading-relaxed">
                            Current level ({currentStock} units) exceeds reorder alert ({reorderLevel}). AI restock suggestions activate on low stock.
                        </p>
                    </div>
                    <Button
                        type="button"
    ...
    return (
        <div className="relative overflow-hidden rounded-2xl border border-indigo-100/80 bg-white p-5 shadow-xs transition-all space-y-4">
            {/* Ambient subtle decorative glow */}
            <div className="pointer-events-none absolute -right-10 -top-10 h-36 w-36 rounded-full bg-gradient-to-br from-indigo-200/20 via-purple-200/10 to-transparent blur-2xl" />

            {/* Header: Title, Copilot pill, and Urgency level */}
            <div className="flex items-start justify-between gap-3 border-b border-slate-100 pb-3.5">
                <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-tr from-indigo-600 to-violet-500 text-white shadow-sm shadow-indigo-100">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-500 mt-0.5">
                            Data-driven replenishment based on sales velocity & warehouse caps
                        </p>
                    </div>
                </div>
