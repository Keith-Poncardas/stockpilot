...
export function NotesSection({ control }: NotesSectionProps) {
    ...
    return (
        <FormSection
            title="Notes"
            description="Add any extra detail, such as what happened or where the stock was found."
            ...
            <Controller
                ...
                render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                        {/* Label row with live char counter on the right */}
                        ...
                        <Textarea
                            ...
                            rows={4}
                            maxLength={MAX_NOTES}
                            placeholder="e.g. Recounted after weekly audit, found 3 extra units in aisle B4."
