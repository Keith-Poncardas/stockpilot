...
TransactionSummaryCard.Skeleton = function TransactionSummaryCardSkeleton() {
    return (
        <FormSection
            title="Transaction Summary"
            description="Key sale metadata and order status."
...
CashierInfoCard.Skeleton = function CashierInfoCardSkeleton() {
    return (
        <FormSection
            title="Cashier Information"
            description="User who processed this sale."
...
CustomerInfoCard.Skeleton = function CustomerInfoCardSkeleton() {
    return (
        <FormSection
            title="Customer Information"
            description="Linked customer profile."
